...
# Interface organizada em colunas
# ==========================================================
...
@st.cache_data
def carregar_dados():
    df = pd.read_excel("data/chave.xlsx")
    return df

df = carregar_dados()

# coluna com nome da espécie
...
# ----------------------------------------------------------
# COLETAR ENTRADA DO USUÁRIO EM COLUNAS
# ----------------------------------------------------------
...
if st.button("Identificar Espécie"):
    ...
    # ------------------------------------------------------
    # VERIFICAR SE NÃO HOUVE CORRESPONDÊNCIA
    # ------------------------------------------------------
